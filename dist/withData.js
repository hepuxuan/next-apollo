  ...
  return function(ComposedComponent) {
    ...
    return (
        ...
        (function(_React$Component) {
                          ...
                          switch ((_context.prev = _context.next)) {
                            ...
                            case 14:
                              ...
                              if (apolloConfig.onSsrError) {
                                apolloConfig.onSsrError(_context.t0)
                              } else {
          ...
          function WithData(props) {
            ...
            _this = (0, _possibleConstructorReturn2.default)(
              this,
              (0, _getPrototypeOf2.default)(WithData).call(this, props)
            )
            _this.apollo = (0, _initApollo.default)(
              apolloConfig,
      ...
      (0, _defineProperty2.default)(
        _class,
        'displayName',
        'WithData('.concat(getComponentDisplayName(ComposedComponent), ')')
      ),
